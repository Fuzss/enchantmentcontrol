...
public class ModMixinConfigPlugin implements IMixinConfigPlugin {
    ...
    private class MapBackedURLStreamHandler extends URLStreamHandler {
        ...
        protected URLConnection openConnection(URL url) throws IOException {
            if (!ModMixinConfigPlugin.this.additionalUrls.containsKey(url.getPath())) return null;
            return new URLConnection(url) {
                ...
                public InputStream getInputStream() throws IOException {
                    return new ByteArrayInputStream(ModMixinConfigPlugin.this.additionalUrls.get(this.getURL().getPath()));
                }
